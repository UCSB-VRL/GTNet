...
OBJ_PATH_train_s = all_data_dir+'Object_Detections_vcoco/vcoco_res50_fpn/train/'
OBJ_PATH_test_s= all_data_dir+'Object_Detections_vcoco/vcoco_res50_fpn/val/' 
...
def visual(image_id,flag,pairs_info,score_HOI,score_interact,score_obj_box,score_per_box,ground_truth,all_utils):
	start=0
	for batch in range(len(image_id)):
		this_image=int(image_id[batch])
		a=all_utils[(this_image,flag)]
